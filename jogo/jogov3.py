# Projeto 1 - Desenvolvimento de Game em Linguagem Python - Versão 3
...
def game():
    ...
    with open("arquivos/palavras_forca.txt", "r", encoding="utf-8") as arquivo:
        palavra = None
        for i, p in enumerate(arquivo, 1): # Enumero os arquivos a partir de 1 para cada índice e palavra do arquivo.
            if rd.randint(1, i) == 1: # No final da contagem de linhas da lista, irei sortear a palavra.
                palavra = p
